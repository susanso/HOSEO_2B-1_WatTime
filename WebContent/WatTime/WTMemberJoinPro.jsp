...
<link href = "style.css" rel = "stylesheet" type = "text/css">
	...
	<%
		String pageChange;
			...
			WatTimeMemberDTO member = memMgr.setMemberJoin(memId, memPass, memName,  memEmail, memPhone, memBirth,  memPostcode, memRoadAddress, memJibunAddress, memEtcAddress, memDetailAddress);
	%>
</head>
<body>
