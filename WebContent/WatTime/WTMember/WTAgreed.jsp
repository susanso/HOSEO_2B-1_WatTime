...
<script type="text/javascript"> 
	function agree() { 
		...
		//체크 박스를 모두 체크 했을 경우
		if(chk) {
			location.href="?pageChange=WTMember/WTMemberJoin.jsp"
...
<body>
	<div id="agreeMain">
		<h1>이용약관</h1>
		<div>
			<textarea readonly="readonly" cols="150" rows="15" style="resize: none;">
인터넷 쇼핑몰 『WatTime 사이버 몰』회원 약관

​제1조(목적)

이 약관은 ( WatTime 회사(전자상거래 사업자)가 운영하는 ( WatTime 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)

① “몰”이란 ( WatTime 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 ( WatTime 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.
		...
		<div>
			<input type="checkbox" name = "agree" id="chk2"/> 개인정보 수집 동의합니다.
		</div>
