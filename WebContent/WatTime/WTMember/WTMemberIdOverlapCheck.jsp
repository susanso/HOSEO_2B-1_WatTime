...
<script language = "JavaScript" src = "../WTMember/js/WTMemberOverlap.js"></script>
</head>
...
<%
	...
	memberDTO = memberDAO.getMemberIdOverlapCheck(memId);
	//아이디 중복이 아닐 경우
...
%>	
		<div class="form">
			...
			<input class="idCheckBtn" type="button" id="useMemId" name="useMemId" value="사용하기" onclick="useMemIdBtn()">
		</div>
<%	
	//중복일 경우
	}else{
%>	
		<div class="form">
			...
			<div class="subForm">
				...
				<input class="idCheckBtn" type="button" id="memIdReCheck" name="memIdReCheck" value="중복확인" onclick="idReOverlap()">	
			</div>
		</div>
<% 
	}
