...
<body>
	<div class = "member">
		...
		<div class="memberForm">
			<form class="w3-container" method = "post" id = "memJoinForm" name = "memJoinForm" action = "WTMemberJoinPro.jsp">
				<!-- 아이디 -->
				<div class="memList">
					<div>
				...
				<!-- 비밀번호 -->
				<div class="memList">
					<div><input class="passInputText" type="password" id="memPass" name="memPass" placeholder="패스워드(영문,숫자,특수문자 조합 8~25자)" onblur="passCheck()" required></div>
				<!-- 비밀번호 찾기 -->
					<div><input class="passInputText" type="password" id="memPassCheck" name="memPassCheck" placeholder="패스워드 확인" onblur="passCheck()" required></div>
				...
				<div class="memList">
					<div class="addressForm">
						<input class="postText" type="text" id="memPostcode" name="memPostcode" size = "10" placeholder="우편번호" readonly>
						<input class="checkBtn" type="button" onclick="postcode()" value="우편번호 찾기">
					</div>
					
					<div class="addressForm">
						<input class="inputText" type="text" id="memRoadAddress" name="memRoadAddress" placeholder="도로명주소" readonly>
					</div>
					<div class="addressForm">
						<input class="inputText" type="text" id="memJibunAddress" name="memJibunAddress" placeholder="지번주소" readonly>
					</div>
					<div class="addressForm">
						<input class="inputText" type="text" id="memEtcAddress" name="memEtcAddress" placeholder="기타주소" readonly>
					</div>
					<div class="addressForm">
						<input class="singleText" type="text" id="memDetailAddress" name="memDetailAddress" placeholder="상세주소" onblur="addressCheck()">
					</div>
					<div class="addressForm">
